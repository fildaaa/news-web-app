...
const Indonesia = () => {
    ...
    useEffect(() => {
        const fetchNews = async () => {
            const response = await axios.get(`https://api.nytimes.com/svc/archive/v1/2024/1.json?q=Indonesia&api-key=sEWt9ftM7MeoEZVw0Yf9jOTaoEoHfsp3`);
    ...
    return (
        <div>
            <h1>Berita Terkini Indonesia</h1>
            {news.map(article => (
                <div key={article.url}>
